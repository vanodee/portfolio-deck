...
| Dock formation | 1400ms | openEase | glass shell width/height/radius expansion (small circle → full pill/column, §3.3) + per-button stagger (90ms/button), starts right after the logo crossfade (§3.5) — *placeholder, pending tuning* |
